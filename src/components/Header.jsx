    ...
    <header className="bg-[var(--bg-color)] p-4 fixed w-full top-0 z-50 border-b border-[var(--neon-purple-dark)]" role="banner">
      <div className="container mx-auto flex justify-between items-center">
        <h1 className="text-2xl font-bold text-[var(--heading-color)]">
          <a 
            href="/" 
            className="hover:text-[var(--neon-purple-light)] transition-colors focus:outline-none focus:ring-2 focus:ring-[var(--neon-purple)]" 
            aria-label="Navigate to Neon Injector homepage"
          >
            Neon Injector
          </a>
        </h1>
